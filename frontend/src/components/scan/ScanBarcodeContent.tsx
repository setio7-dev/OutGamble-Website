  ...
  return (
    <SafeAreaView classNameParent={"h-auto"} classNameChild={"justify-center flex-col mt-18"}>
        ...
        <AnimationDiv effect="fade-up" delay={400} className="flex w-full flex-col gap-4 mt-10">
            <ModernInput type="file" typeInput="file" title="Unggah Media" desc="Tambahkan Foto Anda didalam Input ini" placeholder=""/>
            ...
            <ModernInput type="input" typeInput="text" title="Masukkan tautan QR di bawah ini" placeholder="Link Website..."/>
            <div className="w-full flex justify-center mt-8">
                <PrimaryButton Text="Pindai" Rounded={12} Type="primary" PaddingX={60} />
            </div>
        </AnimationDiv>
    </SafeAreaView>
  )
