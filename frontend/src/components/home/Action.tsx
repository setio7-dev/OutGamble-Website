    ...
    return (
        <div className="w-full flex flex-col justify-center">
            ...
            <SafeAreaView classNameChild={"flex-col justify-center"}>
                <AnimationDiv effect="fade-up" className="flex lg:flex-row flex-col gap-2 justify-between items-center mt-12 w-full">
                    <h1 className="font-poppins-semibold lg:text-[38px] text-[24px] text-white">Mengubah Kesadaran <br className="lg:block hidden" /> Menjadi <span className="text-primary">Gerakan Nyata</span></h1>
                    <p className="font-poppins-regular lg:text-[14px] text-[12px] lg:w-[500px] w-full lg:text-right text-justify text-white">Kami percaya bahwa kesadaran digital adalah kunci untuk masa depan yang lebih baik. Melalui Out Gamble, kami hadir sebagai platform edukasi yang membantu masyarakat memahami bahaya judi online dan memberikan solusi nyata untuk mencegahnya.</p>
                </AnimationDiv>
                <div className="flex lg:flex-row flex-col lg:justify-between justify-center lg:gap-0 gap-10 items-center mt-12 w-full">
