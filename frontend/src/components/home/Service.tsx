...
export default function Service() {
  return (
    <SafeAreaView classNameParent={"h-[110vh] bg-linear-to-r from-[#005625] to-[#05B14F]"} classNameChild={"h-full flex-col justify-center items-start gap-6"}>
        <AnimationDiv effect="fade-up" className="flex w-full flex-col gap-6">
            ...
            <img src={circle} className="w-40 animate-autoRotates h-auto absolute -right-46" alt="" />
        </AnimationDiv>
